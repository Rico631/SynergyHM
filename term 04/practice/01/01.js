...
// Пояснение:
// Положительные элементы: 1, 3, 4 → сумма = 8, количество = 3
// Элементы > B (2): 3, 4 → количество = 2, произведение = 3 * 4 = 12
// Результат:
// {
//   sum_positive: 8,
//   count_positive: 3,
...
// Массив: [-1, -2, -3] | B = 0
// Пояснение:
// Нет положительных чисел → сумма = 0, количество = 0
// Нет чисел больше B → количество = 0, произведение по умолчанию = 1
// Результат:
// {
//   sum_positive: 0,
//   count_positive: 0,
...
// Массив: [] | B = 5
// Пояснение:
// Пустой массив → все показатели = 0, произведение по умолчанию = 1
// Результат:
// {
//   sum_positive: 0,
//   count_positive: 0,
...
// Массив: [10, 20, 30] | B = 5
// Пояснение:
// Все элементы положительные → сумма = 60, количество = 3
// Все > B → количество = 3, произведение = 10 * 20 * 30 = 6000
// Результат:
// {
//   sum_positive: 60,
//   count_positive: 3,
...
// Пояснение:
// Положительные: 5, 6, 2, 1 → сумма = 14, количество = 4
// Нет элементов > 10 → количество = 0, произведение по умолчанию = 1
// Результат:
// {
//   sum_positive: 14,
//   count_positive: 4,
